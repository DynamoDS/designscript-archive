// PB: move this to a separate library
...
//                    mColors = new Color[host.NumVertices];
//                else
//                {
...
//            {
//                if (null == mNormals)
//                    mNormals = SubDMeshEntity.GetVertexNormals().ConvertAll((IVectorEntity v) => new Vector(v));
//                return mNormals;
//            }
//        }
...
//                    if (!entity.UpdateSubDMeshNormals(vertexNormals.ConvertAll((Vector v)=>v.VectorEntity)))
//                        throw new System.InvalidOperationException(string.Format(Properties.Resources.OperationFailed, kMethodName));
//                }
