...
{
    public class DynamoNodeValueReadyEventArgs : EventArgs
    {
        public DynamoNodeValueReadyEventArgs(RuntimeMirror mirror, Guid nodeGuid)
    ...
    public class DynamoNodeValueNotAvailableEventArgs : DynamoNodeValueReadyEventArgs
    {
        public DynamoNodeValueNotAvailableEventArgs(Guid nodeGuid) :
            base(null, nodeGuid, EventStatus.OK, "Not value available for this node")
        { }
    }

    public class DynamoGraphUpdateReadyEventArgs : EventArgs
    {
        ...
        public DynamoGraphUpdateReadyEventArgs(GraphSyncData syncData)
            : this(syncData, EventStatus.OK, null)
        {
        }

        public DynamoGraphUpdateReadyEventArgs(GraphSyncData syncData, EventStatus resultStatus, String errorString)
        {
    ...
    public delegate void DynamoNodeValueReadyEventHandler(object sender, DynamoNodeValueReadyEventArgs e);
    public delegate void DynamoGraphUpdateReadyEventHandler(object sender, DynamoGraphUpdateReadyEventArgs e);
}
