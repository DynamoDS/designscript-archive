...
namespace ProtoTest.TD.Associative
{
    class InlineCondition
    {
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(@"..\\..\\..\\Scripts\\TD\\Associative\\InlineCondition\\T001_Inline_Using_Function_Call.ds");
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(@"..\\..\\..\\Scripts\\TD\\Associative\\InlineCondition\\T002_Inline_Using_Math_Lib_Functions.ds");
        ...
        public void T006_Inline_Using_Different_Sized_1_Dim_Collections()
        {
            ...
            ExecutionMirror mirror = thisTest.RunScript(@"..\\..\\..\\Scripts\\TD\\Associative\\InlineCondition\\T006_Inline_Using_Different_Sized_1_Dim_Collections.ds");
        ...
        public void T008_Inline_Returing_Different_Ranks()
        {
            ...
            ExecutionMirror mirror = thisTest.RunScript(@"..\\..\\..\\Scripts\\TD\\Associative\\InlineCondition\\T008_Inline_Returing_Different_Ranks.ds");
        ...
        public void T009_Inline_Using_Function_Call_And_Collection_And_Replication()
        {
            ...
            thisTest.VerifyRunScriptFile(testPath, "T009_Inline_Using_Function_Call_And_Collection_And_Replication.ds", errmsg);
        ...
        public void T010_Defect_1456751_replication_issue()
        {
            ...
            thisTest.VerifyRunScriptFile(testPath, "T010_Defect_1456751_replication_issue.ds", errmsg);
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(@"..\\..\\..\\Scripts\\TD\\Associative\\InlineCondition\\T010_Defect_1456751_execution_on_both_true_and_false_path_issue.ds");
            thisTest.Verify("x", 3);
            thisTest.Verify("a", 1);
        }
