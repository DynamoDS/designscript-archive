...
";
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(testCasePath + "TestTryCatchStackUnwinding01.ds");
            Assert.IsTrue((Int64)mirror.GetValue("y1").Payload == 1);
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(testCasePath + "TestTryCatchGetExceptionValue01.ds");
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(testCasePath + "TestTryCatchGetExceptionValue02.ds");
            Assert.IsTrue((Int64)mirror.GetValue("y").Payload == 3);
        }
        ...
        {
            ExecutionMirror mirror = thisTest.RunScript(testCasePath + "TestTryCatchGetExceptionValue03.ds");
            Assert.IsTrue((Int64)mirror.GetValue("y").Payload == 3);
        }
